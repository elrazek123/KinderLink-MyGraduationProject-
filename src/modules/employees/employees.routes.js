...
// get for the busSupervisor the children accounts:
employeeeRouter.get("/getChildrenAccountOrGetByFilterForBusSupervisor",authnetecatedEmployee,authorizedEmployee("busSupervisor"),queryValidation(employeeeSchema.getFilterForAccount),employeeController.getAccouentForBusSuperviosr);
// get  for sueprvisor the children account:
employeeeRouter.get("/getAccountsDetailsForSuperviosr",authnetecatedEmployee,authorizedEmployee("supervisor"),queryValidation(employeeeSchema.getFilterForAccount),employeeController.getAccountsForSuperviosr)
